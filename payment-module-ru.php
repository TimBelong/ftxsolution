<?php
/*
Template Name: payment-module-ru
*/
?>
...
<head>
    ...
    <title>FTXsolution | Платежи и переводы</title>
...
<body>
        ...
        <div class="container">
            <div class="wrapper">
                <ul class="menu_list">
                    ...
                    <li><a href="payment-module">en</a></li>
                </ul>
        ...
        <div class="container">
            ...
            <div class="wrapper">
                <div class="main_banner-descr">
                    <h1 class="title">Платежи и Переводы</h1>
                    <ul>
                        <li>Модуль "Платежи и Переводы” фокусируется на обработке и управлении всеми видами платежей и
                            переводов. </li>
                    </ul>
                    <a href="contacts-ru" class="btn">Свяжитесь с нами</a>
                </div>
                <div class="main_banner-img">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/payment.webp" alt="Payments and Transfers"
                        class="payments">
                </div>
            </div>
    ...
    <div class="transfers__module">
        <div class="container">
            <div class="breadscrump">
                <a href="home-ru">Главная /</a> Платежи и Переводы
            </div>
            <div class="wrapper">
                <h2 class="title">Модуль Платежи и Переводы</h2>
                <ul>
                    <li class="item_title">
                        <span> <img src="<?php bloginfo('template_url'); ?>/assets/img/icons/sepa.png"
                                alt="SEPA Payments"></span>
                        <h3 class="item_title">SEPA Платежи</h3>
                        <p class="item_descr">Обеспечивает возможность проведения платежей в рамках единой зоны платежей
                            в евро (SEPA), позволяя пользователям эффективно осуществлять трансграничные платежи внутри
                            Евросоюза </p>
                    </li>
                    <li class="item_title">
                        <span><img src="<?php bloginfo('template_url'); ?>/assets/img/icons/wire-transfers-colored.png"
                                alt="WIRE Transfers"></span>
                        <h3 class="item_title">Международные Банковские переводы </h3>
                        <p class="item_descr">Поддержка международных банковских переводов (Wire Transfers), что делает
                            процесс отправки и получения крупных сумм за границу быстрым и безопасным.. </p>
                    </li>
                    <li class="item_title">
                        <span><img src="<?php bloginfo('template_url'); ?>/assets/img/icons/domestic-payments.png"
                                alt="Domestic Payments"></span>
                        <h3 class="item_title"> Внутренние платежи</h3>
                        <p class="item_descr">Управление внутренними платежами, позволяя осуществлять быстрые и надежные
                            транзакции в пределах одной страны.</p>
                    </li>
                    <li class="item_title">
                        <span><img src="<?php bloginfo('template_url'); ?>/assets/img/icons/deposits.png"
                                alt="Deposits by Card"></span>
                        <h3 class="item_title">Внесение депозитов с использованием карты</h3>
                        <p class="item_descr">Возможность проведения депозитов через банковские карты, что обеспечивает
                            удобство и гибкость для пользователей при пополнении счетов</p>
                    </li>
                    <li class="item_title">
                        <span><img src="<?php bloginfo('template_url'); ?>/assets/img/icons/payouts.png"
                                alt="Payouts to Card"></span>
                        <h3 class="item_title">Выплаты на карту</h3>
                        <p class="item_descr">Функционал для осуществления выплат на банковские карты, упрощая процесс
                            возврата средств или выплаты доходов клиентам.</p>
                    </li>
                    <li class="item_title">
                        <span><img src="<?php bloginfo('template_url'); ?>/assets/img/icons/internal-pyouts.png"
                                alt="Online Management Reporting"></span>
                        <h3 class="item_title">Платежи в рамках системы </h3>
                        <p class="item_descr">Управление внутренними платежами и переводами между счетами внутри
                            системы, что повышает оперативность и удобство для пользователей.</p>
                    </li>
                </ul>
                <a href="contacts-ru" class="btn">Свяжитесь с нами</a>
            </div>
